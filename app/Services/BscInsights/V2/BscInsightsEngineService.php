                    ...
                    'items' => [
                        ...
                        'properties' => [
                            ...
                            'evidencias'             => ['type' => 'array', 'items' => [
                                ...
                                'required' => ['metrica', 'valor', 'variacao'],
                                'additionalProperties' => false,
                            ]],
                            'confidence'   => ['type' => 'integer'],
                            'impact_score' => ['type' => 'number'],
                        ],
                        'required' => ['perspectiva','severidade','titulo','descricao','recomendacao','acao_sugerida','metricas_referenciadas','evidencias','confidence','impact_score'],
                        'additionalProperties' => false,
                    ],
                ],
                'meta' => [
