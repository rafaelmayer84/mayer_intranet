        ...
        foreach ($rows as $mov) {
            try {
                ...
                $dadosNovos = [
                    ...
                    'plano_conta_id' => ($mov['planoContaId'] ?? '') !== '' ? (int)$mov['planoContaId'] : null,
                    'pessoa_id_datajuri' => ($mov['pessoaId'] ?? '') !== '' ? (int)$mov['pessoaId'] : null,
                    'contrato_id_datajuri' => ($mov['contratoId'] ?? '') !== '' ? (int)$mov['contratoId'] : null,
                    'processo_pasta' => $mov['processo.pasta'] ?? null,
                    'proprietario_nome' => $mov['proprietario.nome'] ?? null,
                    'proprietario_id' => ($mov['proprietarioId'] ?? '') !== '' ? (int)$mov['proprietarioId'] : null,
