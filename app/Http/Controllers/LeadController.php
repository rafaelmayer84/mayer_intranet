...
class LeadController extends Controller
{
    ...
    /**
     * Dashboard principal da Central de Leads � Marketing Jur�dico
     */
    public function index(Request $request): View
    {
        ...
        $leadsNao = (clone $query)->where('intencao_contratar', 'n�o')->count();
    ...
    {
        // ---- IN�CIO BLOCO NEXO v1.2 ----
        // Detectar se � incoming_message do SendPulse para o Nexo
        ...
        if (data_get($event, 'title') === 'incoming_message') {
            ...
            // N�O retornar aqui � deixar o fluxo de leads continuar
        }
        // ---- FIM BLOCO NEXO v1.2 ----
    ...
    public function export(Request $request)
    {
        ...
        $callback = function() use ($leads, $tipo) {
            ...
            switch ($tipo) {
                case 'palavras_chave':
                    fputcsv($file, ['Palavra-chave', 'Frequ�ncia', '�rea Predominante'], ';');
                    $keywords = [];
                ...
                case 'gclid':
                    fputcsv($file, ['Nome', 'Telefone', 'GCLID', '�rea', 'Cidade', 'Inten��o', 'Data'], ';');
                ...
                default: // completo
                    fputcsv($file, [
                        'ID', 'Nome', 'Telefone', 'Cidade', '�rea Jur�dica', 'Sub-�rea',
                        'Resumo da Demanda', 'Palavras-chave', 'Inten��o de Contratar',
                        'Justificativa', 'Urg�ncia', 'Complexidade', 'Potencial Honor�rios',
                        'Perfil Socioecon�mico', 'Gatilho Emocional', 'Obje��es',
                        'Origem Canal', 'GCLID', 'Status', 'Data Entrada', 'Data Cria��o'
                    ], ';');
                    foreach ($leads as $lead) {
                        fputcsv($file, [
