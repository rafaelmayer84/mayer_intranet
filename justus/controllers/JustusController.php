...
class JustusController extends Controller
{
    ...
    public function createConversation(Request $request)
    {
        ...
        SystemEvent::sistema(
            'JUSTUS: Nova conversa criada',
            'info',
            ['conversation_id' => $conversation->id, 'type' => $conversation->type],
            $user->id
        );
    ...
    public function upload(Request $request, int $conversationId)
    {
        ...
        SystemEvent::sistema(
            'JUSTUS: PDF enviado para processamento',
            'info',
            [
    ...
    public function approve(Request $request, int $conversationId)
    {
        ...
        if ($action === 'request') {
            ...
            SystemEvent::sistema('JUSTUS: Aprovação solicitada', 'info', [
                'conversation_id' => $conversation->id,
            ...
            SystemEvent::sistema("JUSTUS: Peça {$action}d", 'info', [
                'conversation_id' => $conversation->id,
                'approval_id' => $approval->id,
            ], $user->id);
        }
