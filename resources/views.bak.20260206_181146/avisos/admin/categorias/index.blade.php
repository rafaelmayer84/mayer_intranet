...
<div class="space-y-6">
    <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('admin.categorias-avisos.create') }}" class="inline-flex items-center rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-500">Nova categoria</a>
        </div>
    </div>
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-slate-900/40">
                        ...
                        <td class="px-4 py-3 text-right text-sm">
                            <div class="flex justify-end gap-2">
                                <a href="{{ route('admin.categorias-avisos.edit', $c) }}" class="rounded-lg bg-indigo-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-indigo-700 dark:bg-slate-100 dark:text-slate-900">Editar</a>
