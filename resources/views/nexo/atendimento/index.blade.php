    ...
    <div id="chat-panel" class="hidden lg:flex flex-1 flex-col bg-[#f0f2f5] min-w-0 overflow-hidden">
        ...
        <div id="chat-input-bar" class="hidden px-4 py-3 bg-white border-t-0">
            ...
            <div class="flex items-end gap-3">
                ...
                <button id="nexo-mic-btn" onclick="NexoApp.toggleRecording()" title="Gravar áudio"
                    class="flex-shrink-0 w-11 h-11 rounded-full bg-gray-100 hover:bg-gray-200 text-gray-500 hover:text-gray-700 flex items-center justify-center transition-all active:scale-95">
                ...
                <span id="nexo-rec-timer" class="hidden text-xs text-red-600 font-mono font-bold min-w-[45px]">00:00</span>
