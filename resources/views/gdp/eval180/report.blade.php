                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-3 py-3 text-center">
                                    ...
                                    @elseif($row['status'] === 'released')
                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-700">👁 Liberado</span>
                                    @elseif($row['status'] === 'pending_feedback')
                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-orange-100 text-orange-700">⏳ Aguard. feedback</span>
                                    @elseif($row['manager_submitted'])
                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-700">✅ Gestor avaliou</span>
                                    @elseif($row['self_submitted'])
                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-700">📝 Auto enviada</span>
                                    @else
                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-600">⏳ Pendente</span>
                                    @endif
                                </td>
