            ...
            <nav class="flex-1 p-4 space-y-1">
                ...
                <div class="menu-group">
                    ...
                    <div id="submenu-resultados" class="submenu {{ request()->is('visao-gerencial*') ? 'open' : '' }} ml-4 mt-1 space-y-1">
                        ...
                        <a href="{{ route('clientes-mercado.index') }}"
                        ...
                        <a href="{{ route('clientes-mercado.index') }}" class="nav-sublink flex items-center px-4 py-2 text-sm rounded-lg transition-colors {{ request()->routeIs('clientes-mercado.*') ? 'nav-sublink-active' : '' }}">
                            <span class="w-4 h-4 mr-3" aria-hidden="true">⚙️</span>
                            Processos Internos
                        </a>
