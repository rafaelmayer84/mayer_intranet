    ...
    <div class="rounded-2xl border-t-4 border-blue-500 bg-white p-6 shadow-sm dark:bg-gray-800">
        ...
        <div class="flex gap-2">
            <button
                ...
                class="flex-1 rounded-lg bg-brand px-4 py-2 text-sm font-medium text-white hover-bg-brand-dark focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:bg-blue-500 dark:hover:bg-brand">
                🔄 Sincronizar Tudo
            </button>
            <button
