            ...
            <nav class="flex-1 p-4 space-y-1">
                ...
                <a href="<?php echo e(route('avisos.index')); ?>"
                   ...
                   data-tooltip="Quadro de Avisos">
                    ...
                    <!-- Manuais Normativos -->
                    <a href="<?php echo e(route('manuais-normativos.index')); ?>"
                       class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg transition-colors duration-150 <?php echo e(request()->is('manuais-normativos*') ? 'bg-blue-50 text-blue-700 dark:bg-blue-900/50 dark:text-blue-300' : 'text-gray-600 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-gray-700/50'); ?>">
