...
<div id="nexo-app" class="flex h-[calc(100vh-64px)] bg-gray-100 overflow-hidden">
    ...
    <div id="contexto-panel" class="hidden xl:flex w-[320px] flex-shrink-0 flex-col bg-white border-l border-gray-200 overflow-hidden">
        ...
        <?php echo $__env->make('nexo.atendimento.partials._contexto_datajuri', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('nexo.atendimento.partials._nexo_scripts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u492856976/domains/mayeradvogados.adv.br/public_html/Intranet/resources/views/nexo/atendimento/index.blade.php ENDPATH**/ ?>