<?php $__env->startSection('title', 'Visão Gerencial'); ?>

<?php $__env->startSection('content'); ?>
<link rel="stylesheet" href="<?php echo e(asset('css/dashboard-custom.css')); ?>">
...
<div id="dashboard-root" class="space-y-6 dashboard-fadein" data-api-url="<?php echo e(route('api.visao-gerencial')); ?>" data-export-url="<?php echo e(route('visao-gerencial.export')); ?>">
        ...
        <div class="flex flex-col gap-2 sm:flex-row sm:items-center">
            <div class="flex items-center gap-2">
                ...
                <select id="filter-ano" class="rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 shadow-sm focus:outline-none focus:ring dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100">
                    <?php $__currentLoopData = ($anosDisponiveis ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($a); ?>" <?php if((int)$a === (int)$ano): echo 'selected'; endif; ?>><?php echo e($a); ?></option>
            ...
            <div class="flex items-center gap-2">
                ...
                <select id="filter-mes" class="rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 shadow-sm focus:outline-none focus:ring dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100">
                    <?php $__currentLoopData = ($mesesDisponiveis ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mNum => $mLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($mNum); ?>" <?php if((int)$mNum === (int)$mes): echo 'selected'; endif; ?>><?php echo e($mLabel); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        <?php echo $__env->make('dashboard.partials._kpi-card', [
            'id' => 'receita',
            'title' => 'Receita Total',
    ...
    <div class="mt-3 overflow-x-auto">
        <table class="min-w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-800 text-gray-800 dark:text-gray-200">
                ...
                ?>
                <?php $__currentLoopData = $itemsMetas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $real = (float) $it['real'];
                        $meta = (float) $it['meta'];
                    ...
                    ?>
                    <tr>
                        <td class="px-3 py-2 font-medium"><?php echo e($it['label']); ?></td>
                        <td class="px-3 py-2"><?php echo e(($it['fmt'])($real)); ?></td>
                        <td class="px-3 py-2"><?php echo e(($it['fmt'])($meta)); ?></td>
                        <td class="px-3 py-2"><?php echo e(number_format($pct, 1, ',', '.')); ?>%</td>
                        <td class="px-3 py-2">
                            <span class="inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium <?php echo e($st['class']); ?>"><?php echo e($st['label']); ?></span>
                        </td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
...
<div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-5">
    <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
        ...
        <p class="mt-1 text-lg font-semibold text-gray-900 dark:text-gray-100">
            PF <?php echo e($fmtPct($mix['pfPct'] ?? 0)); ?> • PJ <?php echo e($fmtPct($mix['pjPct'] ?? 0)); ?>

        </p>
        <p class="mt-1 text-xs text-gray-600 dark:text-gray-400">
            PF <?php echo e($fmtMoeda($mix['pfValor'] ?? 0)); ?> • PJ <?php echo e($fmtMoeda($mix['pjValor'] ?? 0)); ?>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
        ...
        <p class="mt-1 text-lg font-semibold text-gray-900 dark:text-gray-100"><?php echo e($fmtPct($yoy['yoyPct'] ?? 0)); ?></p>
        <p class="mt-1 text-xs text-gray-600 dark:text-gray-400">
            Atual <?php echo e($fmtMoeda($yoy['atual'] ?? 0)); ?> • Ano ant. <?php echo e($fmtMoeda($yoy['anoAnterior'] ?? 0)); ?>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
        ...
        <p class="mt-1 text-lg font-semibold text-gray-900 dark:text-gray-100"><?php echo e($fmtPct($expense['pct'] ?? 0)); ?></p>
        <p class="mt-1 text-xs text-gray-600 dark:text-gray-400">
            Desp <?php echo e($fmtMoeda($expense['despesas'] ?? 0)); ?> / Rec <?php echo e($fmtMoeda($expense['receita'] ?? 0)); ?>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
        ...
        <p class="mt-1 text-lg font-semibold text-gray-900 dark:text-gray-100"><?php echo e($fmtPct($inad['pctVencidoSobreAberto'] ?? 0)); ?></p>
        <p class="mt-1 text-xs text-gray-600 dark:text-gray-400">
            Vencido <?php echo e($fmtMoeda($inad['totalVencido'] ?? 0)); ?> • Aberto <?php echo e($fmtMoeda($inad['totalAberto'] ?? 0)); ?>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
        ...
        <p class="mt-1 text-lg font-semibold text-gray-900 dark:text-gray-100">
            Concil. <?php echo e($fmtPct($qual['pctConciliadoCount'] ?? 0)); ?>

        </p>
        <p class="mt-1 text-xs text-gray-600 dark:text-gray-400">
            Receita qualif. <?php echo e($fmtMoeda($qual['receitaQualificada'] ?? 0)); ?> / <?php echo e($fmtMoeda($qual['receitaTotal'] ?? 0)); ?>

        </p>
    </div>
</div>
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <?php echo $__env->make('dashboard.partials._health-card', [
            'id' => 'atraso',
...
<div class="mt-4 grid grid-cols-1 gap-4 xl:grid-cols-2">
    <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
        <div class="flex items-center justify-between">
            ...
            <span class="text-xs text-gray-500 dark:text-gray-400">Top3 = <?php echo e(number_format((float)($topAtraso['top3SharePct'] ?? 0), 1, ',', '.')); ?>%</span>
        </div>
        ...
        <div class="mt-4 overflow-x-auto">
            <table class="min-w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-800 text-gray-800 dark:text-gray-200">
                    <?php $__currentLoopData = ($topAtraso['top'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="px-3 py-2"><?php echo e($r['cliente_nome'] ?? ''); ?></td>
                            <td class="px-3 py-2"><?php echo e($fmtMoeda($r['valor'] ?? 0)); ?></td>
                            <td class="px-3 py-2"><?php echo e($fmtPct($r['sharePct'] ?? 0)); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php if(empty($topAtraso['top'])): ?>
        ...
        <div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
            <div class="overflow-x-auto">
                ...
                <table class="min-w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-800 text-gray-800 dark:text-gray-200">
                        <?php $__currentLoopData = ($rubMoM['topAumentos'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="px-3 py-2"><?php echo e($r['rubrica'] ?? ''); ?></td>
                                <td class="px-3 py-2"><?php echo e($fmtPct($r['pct'] ?? 0)); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php if(empty($rubMoM['topAumentos'])): ?>
            ...
            <div class="overflow-x-auto">
                ...
                <table class="min-w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-800 text-gray-800 dark:text-gray-200">
                        <?php $__currentLoopData = ($rubMoM['topReducoes'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="px-3 py-2"><?php echo e($r['rubrica'] ?? ''); ?></td>
                                <td class="px-3 py-2"><?php echo e($fmtPct($r['pct'] ?? 0)); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php if(empty($rubMoM['topReducoes'])): ?>
                            <tr><td class="px-3 py-2 text-gray-500 dark:text-gray-400" colspan="2">Sem dados.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
...
<script type="application/json" id="dashboard-exec-data-json"><?php echo json_encode($dashboardData ?? [], 15, 512) ?></script>
<script>
    // Mantém compatibilidade com versões anteriores (e facilita debug pelo console)
    window.__DASHBOARD_EXEC_DATA__ = window.__DASHBOARD_EXEC_DATA__ ?? <?php echo json_encode($dashboardData ?? [], 15, 512) ?>;
    window.__DASHBOARD_API_URL__ = window.__DASHBOARD_API_URL__ ?? "<?php echo e(route('api.visao-gerencial')); ?>";
    window.__DASHBOARD_EXPORT_URL__ = window.__DASHBOARD_EXPORT_URL__ ?? "<?php echo e(route('visao-gerencial.export')); ?>";
</script>


<script src="<?php echo e(asset('js/dashboard-charts.js')); ?>?v=<?php echo e(filemtime(public_path('js/dashboard-charts.js'))); ?>"></script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u492856976/domains/mayeradvogados.adv.br/public_html/Intranet/resources/views/dashboard/visao-gerencial.blade.php ENDPATH**/ ?>