        ...
        <aside class="sidebar w-64 bg-gray-800 border-r border-gray-700 flex flex-col">
            ...
            <nav class="flex-1 p-4 space-y-1">
                ...
                <div class="menu-group">
                    <button onclick="toggleSubmenu('resultados')" class="nav-link w-full flex items-center justify-between px-4 py-3 rounded-lg transition-colors {{ request()->is('visao-gerencial*') || request()->is('clientes-mercado*') || request()->is('processos-internos*') || request()->is('time-evolucao*') ? 'nav-link-active' : '' }}">
                    ...
                    <div id="submenu-resultados" class="submenu {{ request()->is('visao-gerencial*') || request()->is('clientes-mercado*') || request()->is('processos-internos*') || request()->is('time-evolucao*') ? 'open' : '' }} ml-4 mt-1 space-y-1">
                        ...
                        <a href="#" class="nav-sublink nav-sublink-disabled flex items-center px-4 py-2 text-sm rounded-lg transition-colors opacity-50 cursor-not-allowed">
                            <span class="w-4 h-4 mr-3" aria-hidden="true">⚙️</span>
                            Processos Internos
                            <span class="text-xs ml-auto bg-yellow-600 px-2 py-0.5 rounded">Em breve</span>
                        </a>
                        <a href="#" class="nav-sublink nav-sublink-disabled flex items-center px-4 py-2 text-sm rounded-lg transition-colors opacity-50 cursor-not-allowed">
                            <span class="w-4 h-4 mr-3" aria-hidden="true">👥</span>
                            Time &amp; Evolução
                ...
                <!-- Configurações -->
                <a href="{{ route('config.metas-kpi-mensais') }}" 
                   class="nav-link flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('config.*') ? 'nav-link-active' : '' }}">
                    <span class="w-5 h-5 mr-3" aria-hidden="true">📊</span>
                    Metas de KPIs
                </a>
                
                <a href="{{ route('configuracoes.classificacao-contas') }}"
                   class="nav-link flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('configuracoes.classificacao*') ? 'nav-link-active' : '' }}">
                    <span class="w-5 h-5 mr-3" aria-hidden="true">📋</span>
