...
Route::middleware(["auth"])->group(function () {
    ...
    Route::get("/configuracoes/classificacao-contas", [ConfiguracaoController::class, "classificacaoContas"])->name("configuracoes.classificacao-contas");
    Route::post("/configuracoes/salvar-classificacao", [ConfiguracaoController::class, "salvarClassificacao"])->name("configuracoes.salvar-classificacao");
