...
return [
    ...
    */
    'pricing' => [
        'gpt-5.2' => [
            'input_per_1m' => (float) env('JUSTUS_PRICING_GPT52_INPUT', 75.00),
            'output_per_1m' => (float) env('JUSTUS_PRICING_GPT52_OUTPUT', 150.00),
        ],
        'gpt-5-mini' => [
            'input_per_1m' => (float) env('JUSTUS_PRICING_MINI_INPUT', 1.50),
            'output_per_1m' => (float) env('JUSTUS_PRICING_MINI_OUTPUT', 6.00),
        ],
    ],
