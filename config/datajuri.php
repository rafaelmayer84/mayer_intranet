...
return [
    ...
    */
    ...
    'page_size' => env('DATAJURI_PAGE_SIZE', 100),
    ...
    */
    ...
    'modulos' => [
        ...
        'HoraTrabalhada' => [
            ...
            'campos' => 'id,data,duracao,totalHoraTrabalhada,horaInicial,horaFinal,valorHora,valorTotal,assunto,tipo,status,proprietario.id,particular,dataFaturado,dataCadastro',
            'criterio' => null,
            'mapping' => [
                'id' => 'datajuri_id',
                'data' => 'data',
                'duracao' => 'duracao_original',
                'totalHoraTrabalhada' => 'total_hora_trabalhada',
                'horaInicial' => 'hora_inicial',
                'horaFinal' => 'hora_final',
                'valorHora' => 'valor_hora',
                'valorTotal' => 'valor_total_original',
                'assunto' => 'assunto',
                'tipo' => 'tipo',
                'status' => 'status',
                'proprietario.id' => 'proprietario_id',
        ...
        'ContasReceber' => [
            ...
            'campos' => 'id,descricao,valor,dataVencimento,dataPagamento,status,tipo,pessoa.nome,pessoaId,cliente.nome,clienteId,processo.pasta,processoId,contrato.numero,contratoId,observacao,dataCadastro',
            'criterio' => null,
            'mapping' => [
                'id'                => 'datajuri_id',
                'descricao'         => 'descricao',
