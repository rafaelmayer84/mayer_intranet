    ...
    */
    ...
    'connections' => [
        'evidentia' => [
            ...
            'database' => env('DB_EVIDENTIA_DATABASE'),
            'username' => env('DB_EVIDENTIA_USERNAME'),
            'password' => env('DB_EVIDENTIA_PASSWORD'),
            'charset' => 'utf8mb4',
        ...
        'legacy' => [
            ...
            'database' => env('LEGACY_DB_DATABASE', 'u492856976_automsendpulse'),
            'username' => env('LEGACY_DB_USERNAME', 'u492856976_manusai'),
        ...
        'backup_sendpulse' => [
            'driver' => 'mysql',
            'host' => env('BACKUP_SP_DB_HOST', 'localhost'),
            'port' => '3306',
            'database' => env('BACKUP_SP_DB_DATABASE', 'u492856976_backupsendpls'),
            'username' => env('BACKUP_SP_DB_USERNAME', 'u492856976_manusai1'),
            'password' => env('BACKUP_SP_DB_PASSWORD', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => false,
        ...
        // mysql_espo removido em 13/02/2026
